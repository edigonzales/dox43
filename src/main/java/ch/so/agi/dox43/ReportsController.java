...
public class ReportsController {
    ...
    // http://localhost:8080/reports/grundstuecksbeschrieb?x=2607708&y=1228739&format=pdf
    // http://localhost:8080/reports/grundstuecksbeschrieb?x=2608026&y=1228149&format=pdf
    // http://localhost:8080/reports/ewsstandortblatt?x=2608026&y=1228149&format=pdf // At the moment statisches SQL 
    // http://localhost:8080/reports/avmeldewesen?x=2608026&y=1228149&format=xlsx // At the moment statisches SQL
    ...
    // wird.
    @GetMapping(path = "/reports/{report}")
    public ResponseEntity<?> getDocument(@PathVariable("report") String report,
        ...
        String fileExtension = "not_supported";
